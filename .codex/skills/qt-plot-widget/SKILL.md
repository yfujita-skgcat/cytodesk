---
name: qt-plot-widget
description: Guidance for implementing and reviewing CytoDesk Qt plotting widgets and gate editing UI while keeping scientific execution in GUI-independent core APIs. Use when changing PySide6 plot widgets, GUI gate editing, GUI-triggered analysis execution, or plotting display behavior.
---
